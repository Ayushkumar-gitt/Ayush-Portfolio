...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative md:absolute order-2 md:order-none self-center md:self-auto right-auto md:right-32 top-auto md:top-1/2 md:-translate-y-1/2 z-20 w-[55vw] md:w-[25vw] max-w-[400px] aspect-[3/4] group mt-8 md:mt-0 mb-16 md:mb-0" style={{ perspective: "1000px" }}>
      ...
      <div className="z-10 mt-24 md:mt-20 relative pointer-events-none order-1 md:order-none" ref={textRef}>
        <h2 className="hero-role text-lando-lime font-mono text-xs md:text-base tracking-widest uppercase mb-4">
          Web Developer (Fresher)
        </h2>

        <div className="overflow-hidden mb-2">
          <h1 className="hero-text font-display text-[22vw] md:text-[15vw] leading-[0.8] tracking-tighter text-white uppercase mix-blend-difference relative z-30">
            Ayush
          </h1>
        </div>
        ...
        <div className="mt-8 md:mt-24 max-w-2xl hero-summary">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 pointer-events-auto">
            <a href="#projects" className="px-8 py-4 bg-lando-lime text-black font-bold uppercase tracking-widest text-sm hover:bg-white transition-colors duration-300 text-center">
              View Work
            </a>
            <a href="#contact" className="px-8 py-4 border border-gray-700 text-white font-bold uppercase tracking-widest text-sm hover:border-white transition-colors duration-300 cursor-pointer text-center">
              Contact Me
            </a>
          </div>
        </div>
      ...
      {/* Scroll Indicator */}
      <div className="hidden md:flex absolute bottom-10 left-12 flex-col items-center gap-2 opacity-50 hero-summary">
