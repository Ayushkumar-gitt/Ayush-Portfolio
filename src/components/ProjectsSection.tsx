    ...
    >
      ...
      >
        {projects.map((project, index) => (
          <div
            key={index}
            className="project-panel w-screen h-full flex items-center md:px-20 lg:px-32 flex-shrink-0 relative"
          >
            <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row gap-10 items-center justify-between pb-10">
              ...
              <div className="w-full md:w-1/2 space-y-6 z-10">
                ...
                <h3 className="font-display text-4xl md:text-6xl uppercase text-white leading-none">
                  {project.title}
                </h3>
                <h4 className="font-sans text-xl text-gray-400">
                  {project.subtitle}
                </h4>
                <p className="font-sans text-gray-300 font-light max-w-md">
                  {project.description}
                </p>
                <div className="flex flex-wrap gap-2 pt-4">
                  {project.tech.map((t, i) => (
                    <span key={i} className="px-2 py-1 bg-white/10 text-white text-xs font-mono uppercase">
                      {t}
                    </span>
                  ))}
                </div>
              ...
              <div className="w-full md:w-1/2 h-[40vh] md:h-[60vh] relative group overflow-hidden">
